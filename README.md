...
> carries the 71 flags this project raised against itself.
>
...
sim/            the engine - pure standard library, no third-party imports
  config.py         dated fee schedules, tick grid, margin, impact; the
                    73-row verified-source register
...
tests/          539 tests - engine, venue, memory, site, live book, official book, registers, docs, README,
...
research/       VERIFICATION_LOG.md, COMPETITION_SITES.md,
                IRREGULARITIES.json (71), LIMITATIONS.json (43),
...
* [`docs/sources.html`](https://buffedlizard55-lab.github.io/StockPaperSim/docs/sources.html)
  — the 79-row register (73 source rows plus 6 provider rows), every URL
...
* [`docs/irregularities.html`](https://buffedlizard55-lab.github.io/StockPaperSim/docs/irregularities.html)
  — all 71 flags, including the ones raised against this project's own modelling
  choices.
