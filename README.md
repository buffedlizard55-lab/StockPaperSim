...
> carries the 70 flags this project raised against itself.
>
...
sim/            the engine - pure standard library, no third-party imports
  config.py         dated fee schedules, tick grid, margin, impact; the
                    72-row verified-source register
...
tests/          535 tests - engine, venue, memory, site, live book, official book, registers, docs, README,
...
research/       VERIFICATION_LOG.md, COMPETITION_SITES.md,
                IRREGULARITIES.json (70), LIMITATIONS.json (43),
...
python3 -m unittest discover -s tests   # 535 tests
...
* [`docs/sources.html`](https://buffedlizard55-lab.github.io/StockPaperSim/docs/sources.html)
  — the 78-row register (72 source rows plus 6 provider rows), every URL
...
* [`docs/irregularities.html`](https://buffedlizard55-lab.github.io/StockPaperSim/docs/irregularities.html)
  — all 70 flags, including the ones raised against this project's own modelling
  choices.
