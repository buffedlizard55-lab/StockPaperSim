...
def all_verified_sources() -> List[dict]:
    ...
    return [
        ...
        {"claim": "EDGAR daily index directory, one form-type index per filing day (form.YYYYMMDD.idx), used to enumerate the Form 4 filings a date's tape needs", "url": "https://www.sec.gov/Archives/edgar/daily-index/", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "EDGAR submissions API: per-issuer filing history as JSON (data.sec.gov)", "url": "https://data.sec.gov/submissions/", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "Official ticker-to-CIK map, the file the Form 4 walk resolves each issuer's CIK from", "url": "https://www.sec.gov/files/company_tickers.json", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "browse-edgar company filing index (the endpoint that answered HTTP 403 before the declared header set was completed); the form-type filter this project uses is Form 4", "url": "https://www.sec.gov/cgi-bin/browse-edgar", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "EDGAR full-text search API (the JSON endpoint behind efts.sec.gov/LATEST/search-index): match_phrase over filing text with forms=, ciks= and a custom file_date range, up to 100 hits per page. Used as the Form 4 purchase locator: the phrase \"4 P false\" (or \"4 P 0\") is the XML transaction-coding block of a code-P non-derivative row, validated against known MU sales before use; every query URL, hit count and accession is recorded in data/real/sec_agent/fts_locator.json", "url": "https://efts.sec.gov/LATEST/search-index?q=%224%20P%20false%22&forms=4&ciks=0001318605&dateRange=custom&startdt=2025-06-01&enddt=2026-09-21", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "EDGAR filing SGML header page (<accession>-index-headers.html): FILED AS OF DATE, ACCEPTANCE-DATETIME and CONFORMED PERIOD OF REPORT for one filing, read by the rendered Form 4 lane when the rendered -index.htm page answers with the SEC's maintenance page; example is the late-filed MSFT Form 4 0000789019-25-000120", "url": "https://www.sec.gov/Archives/edgar/data/789019/000078901925000120/0000789019-25-000120-index-headers.html", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "Insider Transactions Data Sets: Forms 3/4/5 extracts in flattened quarterly ZIPs, January 2006 to the latest posted quarter, updated quarterly; a filing accepted after 5:30 p.m. ET on a quarter's last business day appears in the next posting", "url": "https://www.sec.gov/data-research/sec-markets-data/insider-transactions-data-sets", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        {"claim": "Insider Transactions Data Sets download root for the quarterly ZIPs (path pattern documented on the data-sets page)", "url": "https://www.sec.gov/files/structureddata/data/insider-transactions-data-sets/", "publisher": "U.S. Securities and Exchange Commission", "status": "FETCHED"},
        ...
        {"claim": "Off-exchange (internalised and ATS) share of consolidated US equity volume, the basis for treating quantity beyond the displayed ladder as non-displayed liquidity at the touch",
         ...
         "status": "KNOWN-NOT-FETCHED"},
        {"claim": "FINRA Trade Activity Fee of $0.000195 per share on equity sells (maximum $9.79 per trade; no equity-trades minimum - the minimum in the TAF rules applies to security-futures round turns) from 2026-01-01",
        ...
        {"claim": "2026 NYSE market holidays and the two 1:00pm ET early closes (2026-11-27, 2026-12-24) used by the venue-admin trading calendar",
         "url": "https://www.nyse.com/trade/hours-calendars",
         "publisher": "New York Stock Exchange",
         "status": "FETCHED-VERIFIED",
         "note": "Fetched 2026-09-19; the table itself, not a secondary calendar site. Embedded with a check date in sim/venue_admin.py (MARKET_HOLIDAYS_2026)."},
        {"claim": "2026 Federal Reserve Banks holiday schedule (Fedwire closure days) used by the venue-admin settlement calendar, including Saturday/Sunday treatment notes",
         "url": "https://www.frbservices.org/about/holiday-schedules",
         "publisher": "Federal Reserve Financial Services",
         "status": "FETCHED-VERIFIED",
         "note": "Fetched 2026-09-19. The older path /resources/holidays now returns 404 (IR-73); only this live page is cited."},
        {"claim": "FINRA Information Notice confirming the SEC Section 31 rate of $20.60 per $1,000,000 effective 2026-04-04 (from $0.00)",
         "url": "https://www.finra.org/rules-guidance/notices/information-notice-20260317",
         "publisher": "FINRA",
         "status": "FETCHED-VIA-SEARCH",
         "note": "Read 2026-09-19 during the fee re-verification pass; matches the FY2026 SEC advisory already in the register."},
        {"claim": "Regular-way settlement is T+1 for most broker-dealer securities transactions from 28 May 2024, the convention the venue-admin settlement_date() function implements against the Fed calendar",
         "url": "https://www.sec.gov/resources-for-investors/investor-alerts-bulletins/new-t1-settlement-cycle-what-investors-need-know-investor-bulletin",
         "publisher": "U.S. Securities and Exchange Commission",
         "status": "KNOWN-NOT-FETCHED"},
        {"claim": "Nasdaq Trader Trade Halts RSS: the official current-halts publication whose rows name symbol, halt date/time, market and reason code in a fixed column order",
         "url": "https://www.nasdaqtrader.com/rss.aspx?feed=tradehalts",
         "publisher": "Nasdaq Trader",
         "status": "FETCHED-VERIFIED",
         "note": "Live document read 2026-09-19; RSS 2.0 with per-item CDATA HTML tables. sim/venue_admin.parse_halts_feed implements exactly the published column order."},
        ...
        {"claim": "TradingView Pricing & Subscription terms: Strategy Tester backtest report data and CSV performance exports are plan-gated behind Essential, Plus, and Premium paid tiers, restricting unauthenticated automated data extraction (IR-63, L-38)",
         "url": "https://www.tradingview.com/pricing/",
         "publisher": "TradingView",
         "status": FETCHED_VERIFIED,
         "note": "Fetched 2026-09-18; verifies that programmatic Strategy Tester trade log exports require paid account authentication."},
        {"claim": "Nasdaq TotalView specification: real-time full order depth and continuous Level 2 equity pricing protocol requiring direct TCP/IP exchange feeds and redistribution authorization (IR-62, L-39)",
         "url": "https://www.nasdaqtrader.com/Trader.aspx?id=Totalview",
         "publisher": "Nasdaq Trader",
         "status": FETCHED_VERIFIED,
         "note": "Fetched 2026-09-18; establishes exchange infrastructure requirements for unthrottled real-time intraday equity execution."},
        {"claim": "NYSE Real-Time Market Data feeds: proprietary Pillar protocol specifications governing real-time top-of-book and depth-of-book market feeds across NYSE, NYSE Arca, and NYSE American (IR-62, L-39)",
         "url": "https://www.nyse.com/market-data/real-time",
         "publisher": "New York Stock Exchange",
         "status": FETCHED_VERIFIED,
         "note": "Fetched 2026-09-18; documents market data licensing and technical feed architecture for real-time exchange feeds."},
        {"claim": "Nasdaq Trader published trading calendar and market holidays: canonical exchange session dates, 13:00 ET early-close sessions, and forward session status projection rules (PROJECTION_SOURCE)",
         "url": "https://www.nasdaqtrader.com/trader.aspx?id=calendar",
         "publisher": "Nasdaq Trader",
         "status": FETCHED_VERIFIED,
         "note": "Fetched 2026-09-18; defines US equity session boundaries, early closes, and forward calendar projections."},
    ]
