...
def all_verified_sources() -> List[dict]:
    ...
    return [
        ...
        {"claim": "FINRA Section 1 member regulatory fees schedule referenced by the methodology's dated Trading Activity Fee disclosure",
         ...
         "publisher": "FINRA",
         "status": "FETCHED",
         "note": "Primary schedule link published for manual review; the dated rates used by config.py are also recorded in the fee-adjustment schedule row above."},
        {"claim": "FINRA SR-FINRA-2024-019 fee filing and 2024 TAF adjustment notice",
         ...
         "status": "FETCHED",
         "note": "Primary filing link cited by the methodology page; the current dated fee values are taken from the newer fee-adjustment schedule."},
        {"claim": "SEC guidance for accessing EDGAR data and identifying automated clients",
         ...
         "publisher": "U.S. Securities and Exchange Commission",
         "status": "FETCHED",
         "note": "Collector User-Agent and request-rate disclosure reference; the retrieved local copy is retained under data/real/regulatory/."},
        ...
        {"claim": "Short-term reversal: the cross-section of stock returns is negatively related to prior-month (and prior-week) returns",
         ...
         "publisher": "Jegadeesh (1990), Journal of Finance 45(3):883-898",
         "status": "KNOWN-NOT-FETCHED"},
        {"claim": "Post-earnings-announcement drift: prices continue to move in the direction of the earnings surprise for weeks",
         ...
         "publisher": "Bernard & Thomas (1989), Journal of Accounting Research",
         "status": "KNOWN-NOT-FETCHED"},
